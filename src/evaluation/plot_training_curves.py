...
EXPERIMENTS = ["zones_paper_s1", "brief_belief_s3"] 
NAME_MAPPING = {
...
METRIC = "return"  # 可选 "return", "success_rate", "violation_rate", "avg_steps"
...
OUT_PATH = Path("/home/gh/公共/image/zones_brief_s3/return.pdf")
# OUT_PATH = OUT_PATH / f"{METRIC}.pdf"
# ==================================================
